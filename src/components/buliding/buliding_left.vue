					...
					<li class="col-sm-12">
                        ...
                        高风险建筑 安全评分最低
								...
								<p class="size-12 font-yellow">
									{{buildCountDataSocre.unitName ? buildCountDataSocre.unitName : "暂无单位"}} - {{buildCountDataSocre.buildingName ? buildCountDataSocre.buildingName : "暂无建筑"}}</p>
							</div>
				...
				<ul class="padding-left10 padding-right5 clearfix">
					...
					<li class="upd-pagin">
						<div>
							...
							<el-pagination style="float: right;background: transparent" small layout="prev, pager, next" :page-size="this.queryBuildList_parameter.pageSize" :total="tableData.totalRow" current-page.sync="this.getAlarmList_parameter.currentPage" @current-change="handleCurrentChange">
							</el-pagination>
						</div>
					</li>
				</ul>
