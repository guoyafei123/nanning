    ...
    <aside>
      <div class="main_header clearFix">
        ...
        <div class="main_nav float-right">
          <router-link to="/Dangerous_goods_management/list"><button @click="btn_add" class="btn_add"><i class="fa fa-th-large font-gray-666 float-left"></i>规划</button></router-link>
        </div>
      </div>
      <div class="main_all_content">
        <div class="main_content_top">
          ...
          <div class="main_nav_two float-right">
            <router-link to="/Dangerous_goods_management/all"><button><i class="fa fa-th-large font-gray-666 float-left"></i>列表</button></router-link>
            <router-link to="/Dangerous_goods_management/maps"><button><i class="fa fa-th-large font-gray-666 float-left"></i>地图</button></router-link>
          </div>
        </div>
      </div>
    </aside>
